...
var MyMinIOFolderPickerViewModel = oop.extend(OauthAddonFolderPicker, {
    ...
    connectAccount: function() {
        ...
        return $osf.postJSON(
            ...
            self.changeMessage('Successfully added My MinIO credentials.', 'text-success', null, true);
            ...
            Raven.captureMessage('Could not add My MinIO credentials', {
                extra: {
    ...
    /**
     * Tests if the given string is a valid My MinIO bucket name.  Supports two modes: strict and lax.
                    ...
                    callback: function () {
                        ...
                        if (!bucketName) {
                            ...
                            bootbox.confirm({
                                ...
                                message: 'My MinIO buckets can contain lowercase letters, numbers, and hyphens separated by' +
...
// Public API
function MyMinIONodeConfig(addonName, selector, url, folderPicker, opts, tbOpts) {
    var self = this;
    self.url = url;
    self.folderPicker = folderPicker;
    opts = opts || {};
    tbOpts = tbOpts || {};
    self.viewModel = new MyMinIOFolderPickerViewModel(addonName, url, selector, folderPicker, opts, tbOpts);
    self.viewModel.updateFromData();
    $osf.applyBindings(self.viewModel, selector);
}

module.exports = {
    MyMinIONodeConfig: MyMinIONodeConfig,
    _MyNinIONodeConfigViewModel: MyMinIOFolderPickerViewModel
};
