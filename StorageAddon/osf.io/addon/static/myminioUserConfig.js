...
var language = require('js/osfLanguage').Addons.myminio;
...
var $modal = $('#myminioInputCredentials');
...
function ViewModel(url) {
    ...
    self.account_url = '/api/v1/settings/myminio/accounts/';
    ...
    self.updateAccounts = function() {
        return $.ajax({
            ...
            $('#myminio-header').osfToggleHeight({height: 160});
...
function MyMinIOUserConfig(selector, url) {
    // Initialization code
    var self = this;
...
module.exports = {
    MyMinIOViewModel: ViewModel,
    MyMinIOUserConfig: MyMinIOUserConfig
};
